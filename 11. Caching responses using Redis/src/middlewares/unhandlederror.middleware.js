...
const { CourseNotFoundError, StudentNotFoundError, DuplicateStudentEmailError } = require('../errors');
...
const UnhandledErrorMiddleware = (err, req, res, next) => {
    ...
    else if (err instanceof DuplicateStudentEmailError) {
        statusCode = StatusCodes.CONFLICT;
        type = 'Duplicate resource error';
        message = err.message;
    }
